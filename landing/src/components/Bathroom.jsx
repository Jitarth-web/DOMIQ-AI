  ...
  return (
    <div className="w-full h-full max-md:h-auto bg-bathroom relative overflow-hidden flex items-center justify-center max-md:py-16 max-md:px-4">
      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col items-center justify-center h-full max-md:h-auto max-md:gap-6">
        ...
        <div className="relative w-[80%] max-md:w-[92vw] max-md:aspect-auto max-w-5xl aspect-[21/9] mt-20 max-md:mt-4 max-md:flex max-md:flex-col">
          ...
          <div className="absolute max-md:relative max-md:bottom-auto max-md:right-auto max-md:left-auto max-md:w-full max-md:rotate-0 max-md:mt-4 max-md:p-6 glass-card p-10 rounded-[40px] w-96 max-md:w-full rotate-[2deg] z-20">
