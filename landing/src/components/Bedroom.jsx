...
const Bedroom = () => {
  return (
    <div className="w-full h-full max-md:h-auto bg-bedroom relative overflow-hidden flex items-center justify-center max-md:py-16 max-md:px-4">
      ...
      <FunkyLabel xOffset={0} yOffset={250} className="bg-white/10 text-white left-10 max-md:hidden">SMART SPACE</FunkyLabel>
      <FunkyLabel xOffset={100} yOffset={-300} className="bg-black/20 text-white right-20 max-md:hidden">98% SYNC</FunkyLabel>
      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col items-center justify-center h-full max-md:h-auto max-md:gap-6">
        ...
        <div className="absolute max-md:relative max-md:top-auto max-md:right-auto max-md:w-full z-30 pointer-events-none text-right max-md:text-center max-md:mb-4 max-md:px-4">
          <h2 className="text-4xl sm:text-6xl md:text-[130px] font-black leading-[0.8] tracking-tighter uppercase drop-shadow-2xl">
            <div className="overflow-hidden pb-2 md:pb-8 pt-2 md:pt-4 -mt-2 md:-mt-4"><div className="animate-text-reveal text-transparent [-webkit-text-stroke:1px_white] md:[-webkit-text-stroke:2px_white] italic pr-4 max-md:pr-0">Perfect</div></div>
            <div className="overflow-hidden pb-2 md:pb-8 pt-2 md:pt-4 -mt-2 md:-mt-4"><div className="animate-text-reveal pr-12 max-md:pr-0">Bedroom</div></div>
          </h2>
        </div>
        ...
        <div className="relative w-[85%] max-md:w-[92vw] max-md:aspect-auto max-w-5xl aspect-[16/9] mt-10 max-md:mt-4 max-md:flex max-md:flex-col">
          <div className="absolute max-md:relative inset-0 max-md:inset-auto max-md:w-full max-md:h-[220px] rounded-[40px] overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.8)] rotate-[4deg] max-md:rotate-0 group z-10 border border-white/20">
            <img
              src={bedroomImg}
              alt="Bedroom"
