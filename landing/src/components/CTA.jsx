    ...
    <div className="w-full h-full max-md:h-auto relative overflow-hidden flex items-center justify-center max-md:py-16 max-md:px-4">
      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col items-center justify-center h-full max-md:h-auto max-md:gap-6">
        ...
        <div className="relative w-[85%] max-md:w-[92vw] max-md:aspect-auto max-w-5xl aspect-[16/9] mt-10 max-md:mt-4 max-md:flex max-md:flex-col">
          ...
          <div className="absolute max-md:relative max-md:bottom-auto max-md:left-auto max-md:right-auto max-md:top-auto max-md:w-full max-md:rotate-0 max-md:mt-4 max-md:p-6 glass-card p-8 rounded-[30px] w-80 rotate-[3deg] z-20">
          ...
          <div className="absolute max-md:relative max-md:bottom-auto max-md:right-auto max-md:left-auto max-md:w-full max-md:mt-4 max-md:flex max-md:justify-center max-md:rotate-0 -bottom-10 -right-5 z-20 rotate-[-2deg]">
            <MagneticButton 
              id="cta-lets-go" 
              onClick={() => {
                if (window.router) {
