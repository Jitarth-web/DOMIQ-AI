...
const Features = () => {
  return (
    <div className="w-full h-full max-md:h-auto bg-features relative overflow-hidden flex items-center justify-center max-md:py-16 max-md:px-4">
      ...
      <FunkyLabel xOffset={-300} yOffset={250} className="bg-purple-600/20 text-purple-400 border-purple-500/30 max-md:hidden">SYSTEM</FunkyLabel>
      <FunkyLabel xOffset={400} yOffset={-200} className="bg-white/10 text-white max-md:hidden">4.0 TFLOPS</FunkyLabel>
      ...
      <div className="w-full max-w-7xl relative z-10 flex flex-col items-center justify-center h-full max-md:h-auto max-md:gap-6">
        ...
        <div className="absolute max-md:relative max-md:top-auto max-md:left-auto max-md:w-full z-30 pointer-events-none max-md:mb-4 max-md:px-4">
          <h2 className="text-4xl sm:text-6xl md:text-[120px] font-black leading-[0.8] tracking-tighter uppercase drop-shadow-2xl max-md:text-center">
            <div className="overflow-hidden pb-2 md:pb-8 pt-2 md:pt-4 -mt-2 md:-mt-4"><div className="animate-text-reveal">Engine</div></div>
            <div className="overflow-hidden pb-2 md:pb-8 pt-2 md:pt-4 -mt-2 md:-mt-4"><div className="animate-text-reveal text-transparent [-webkit-text-stroke:1px_white] md:[-webkit-text-stroke:2px_white] italic pl-24 max-md:pl-0">Features</div></div>
          </h2>
        </div>
